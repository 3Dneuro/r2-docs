...
.. image:: _static/images/r2_drive_on_holder.png
  :alt: An R2drive L on a 3D printed holder with a Neuropixels 1.0 probe mounted to it
  :height: 300px
...
* A surgery holder for implant and explant procedures.
...
.. raw:: html
  ...
  <div class="card-columns" style="display: flex; flex-direction: row; justify-content: space-between; flex-wrap: nowrap; gap: 20px;">
        ...
        <a class="reference internal" href="getting_started/index.html">
            <span class="std std-ref custom-card">
                <div class="card text-center intro-card">
                    <img src="_static/images/icons/manual.png" class="card-img-top hover-zoom" alt="Getting started icon" width="64">
                    <div class="card-body flex-fill">
                        <h5 class="card-title">Getting Started</h5>
                        <p class="card-text">How to get started with the R2 system</p>
                    </div>
                </div>
            </span>
        </a>
        ...
        <a class="reference internal" href="user_manual/index.html">
            <span class="std std-ref custom-card">
                <div class="card text-center intro-card">
                    <img src="_static/images/icons/user-guide.png" class="card-img-top hover-zoom" alt="User manual icon" width="64">
                    <div class="card-body flex-fill">
                        <h5 class="card-title">User Manual</h5>
                        <p class="card-text">Complete guide to using the R2 system</p>
                    </div>
                </div>
            </span>
        </a>
        ...
        <a class="reference internal" href="assembly_guide/index.html">
            <span class="std std-ref custom-card">
                <div class="card text-center intro-card">
                    <img src="_static/images/icons/assembly.png" class="card-img-top hover-zoom" alt="Assembly guide icon" width="64">
                    <div class="card-body flex-fill">
                        <h5 class="card-title">Assembly Guide</h5>
                        <p class="card-text">Step-by-step assembly instructions</p>
                    </div>
                </div>
            </span>
        </a>
